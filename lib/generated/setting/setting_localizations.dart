...
///
/// ```dart
/// import 'setting/setting_localizations.dart';
///
/// return MaterialApp(
...
abstract class SettingLocalizations {
  SettingLocalizations(String locale)
    : localeName = intl.Intl.canonicalizedLocale(locale.toString());

  final String localeName;

  static SettingLocalizations? of(BuildContext context) {
    return Localizations.of<SettingLocalizations>(
      context,
      SettingLocalizations,
    );
  }

  static const LocalizationsDelegate<SettingLocalizations> delegate =
      _SettingLocalizationsDelegate();
...
class _SettingLocalizationsDelegate
    extends LocalizationsDelegate<SettingLocalizations> {
  const _SettingLocalizationsDelegate();

  @override
  Future<SettingLocalizations> load(Locale locale) {
    return SynchronousFuture<SettingLocalizations>(
      lookupSettingLocalizations(locale),
    );
  }
...
SettingLocalizations lookupSettingLocalizations(Locale locale) {
    ...
    case 'zh':
      {
        switch (locale.countryCode) {
          case 'TW':
            return SettingLocalizationsZhTw();
        }
        break;
      }
  }
  ...
  switch (locale.languageCode) {
    case 'en':
      return SettingLocalizationsEn();
    case 'zh':
      return SettingLocalizationsZh();
  }
